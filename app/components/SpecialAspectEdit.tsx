...
export default function SpecialAspectsEdit({categoria, onChangeState, data} : {categoria:string, onChangeState: any, data: any}){

    const dataFunction = () => {
        setAbracadeiraDiametro(data.abracadeiraDiametro);
        setAroTipoFolha(data.aroTipoFolha);
        setArosFuros(data.aroFuros);
        setAroGrossura(data.aroGrossura);
        setBancoTipo(data.bancoTipo);
        setBancoCanoteTamanho(data.bancoCanoteTamanho);
        setBikeCompletaModalidade(data.bikeCompletaModalidade);
        setCamaraAroTamanho(data.camaraAroTamanho);
        setCamaraTipoValvula(data.camaraTipoValvula);
        setCanoteTipo(data.canoteTipo);
        setCanoteTamanho(data.canoteTamanho);
        setCoroaDentes(data.coroaDentes);
        setCoroaProtetor(data.coroaProtetor);
        setCoroaAdaptador(data.coroaAdaptador);
        setCorrenteTipoElo(data.correnteTipoElo);
        setCuboDianteiroFuros(data.cuboDianteiroFuros);
        setCuboDianteiroTipoEixo(data.cuboDianteiroTipoEixo);
        setCuboDianteiroMaterialEixo(data.cuboDianteiroMaterialEixo);
        setCuboDianteiroMaterialParafusos(data.cuboDianteiroMaterialParafusos);
        setCuboDianteiroProtetor(data.cuboDianteiroProtetor);
        setTipoCubo(data.tipoCubo);
        setFreecoaster(data.freecoaster);
        setCuboTraseiroTracao(data.cuboTraseiroTracao);
        setCuboTraseiroCog(data.cuboTraseiroCog);
        setCuboTraseiroTravas(data.cuboTraseiroTravas);
        setCuboTraseiroFuros(data.cuboTraseiroFuros);
        setCuboTraseiroTipoEixo(data.cuboTraseiroTipoEixo);
        setCuboTraseiroMaterialEixo(data.cuboTraseiroMaterialEixo);
        setCuboTraseiroMaterialParafusos(data.cuboTraseiroMaterialParafusos);
        setCuboTraseiroProtetor(data.cuboTraseiroProtetor);
        setEixoCentralEstrias(data.eixoCentralEstrias);
        setEixoCentralTamanho(data.eixoCentralTamanho);
        setFreioPeca(data.freioPeca);
        setGarfoOffset(data.garfoOffset);
        setGarfoTampa(data.garfoTampa);
        setGuidaoTamanho(data.guidaoTamanho);
        setGuidaoLargura(data.guidaoLargura);
        setGuidaoAngulo(data.guidaoAngulo);
        setGuidaoTipo(data.guidaoTipo);
        setManoplaTamanho(data.manoplaTamanho);
        setManoplaBarEnds(data.manoplaBarEnds);
        setMesaTamanho(data.mesaTamanho);
        setMesaAltura(data.mesaAltura);
        setMesaTipo(data.mesaTipo);
        setMesaFabricacao(data.mesaFabricacao);
        setMovimentoCentralTipo(data.movimentoCentralTipo);
        setMovimentoCentralRolamento(data.movimentoCentralRolamento);
        setMovimentoCentralAcompanha(data.movimentoCentralAcompanha);
        setMovimentoDirecaoTipo(data.movimentoDirecaoTipo);
        setMovimentoDirecaoTampa(data.movimentoDirecaoTampa);
        setMovimentoDirecaoAcompanha(data.movimentoDirecaoAcompanha);
        setPedalRosca(data.pedalRosca);
        setPedalConstrucao(data.pedalConstrucao);
        setPedaleiraQuantidade(data.pedaleiraQuantidade);
        setPedaleiraEncaixe(data.pedaleiraEncaixe);
        setPedaleiraTamanho(data.pedaleiraTamanho);
        setPedivelaTracao(data.pedivelaTracao);
        setPedivelaTamanho(data.pedivelaTamanho);
        setPedivelaRolamento(data.pedivelaRolamento);
        setPedivelaEstrias(data.pedivelaEstrias);
        setPedivelaAcompanha(data.pedivelaAcompanha);
        setPedivelaConstrucao(data.pedivelaConstrucao);
        setPneuAro(data.pneuAro);
        setPneuBandaLateral(data.pneuBandaLateral);
        setPneuIndicacao(data.pneuIndicacao);
        setPneuTamanho(data.pneuTamanho);
        setQuadroAbracadeira(data.quadroAbracadeira);
        setQuadroCentral(data.quadroCentral);
        setQuadroDirecao(data.quadroDirecao);
        setQuadroEsticador(data.quadroEsticador);
        setQuadroMedida(data.quadroMedida);
        setQuadroModalidade(data.quadroModalidade);
        setQuadroPinos(data.quadroPinos);
        setQuadroTamanhoAro(data.quadroTamanhoAro);
        setQuadroTolerancia(data.quadroTolerancia);
        setProtetorLado(data.protetorLado);
        setRaioTipo(data.raioTipo);
        setRaioTamanho(data.raioTamanho);
    }
    ...
    if (categoria == "Abraçadeira"){
        return(
            <View>
                ...
                <Text className="text-lg">Diâmetro</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tipo de folha</Text>
                ...
                <Text className="text-lg">Furos</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Grossura dos raios</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tipo de banco</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tamanho do canote</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Modalidade da Bike</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tamanho do aro</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tipo de válvula da Câmara</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tipo</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Quantidade de dentes</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Possui protetor?</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Possui adaptador de eixo?</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tipo de elo</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Quantidade de furos</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tipo de eixo</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Material do eixo</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Material dos parafusos</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Acompanha protetor?</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tração</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tamanho do cog</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tipo do cubo</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                {freecoaster && (
                    <View>
                        <Text className="text-lg">Quantidade de travas</Text>
                        <View className="border bg-purple-100 border-black rounded-md mb-6">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Quantidade de estrias</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tamanho do rolamento para o eixo</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Qual a peça?</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tamanho do Offset</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tipo de tampa</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tamanho do Guidão (ou tamanho aproximado)</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Largura (ou aproximado)</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Ângulo do recuo (ou apromixado)</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Ângulo da elevação (ou apromixado)</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                    <Picker selectedValue={guidaoAngulo} onValueChange={(value)=>{setGuidaoAngulo(value); onChange()}}>
                        <Picker.Item label="Selecione uma opção" value={null}></Picker.Item>
                ...
                <Text className="text-lg">Tipo de guidão</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tamanho (ou aproximado)</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Acompanha bar ends?</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                ...
                <Text className="text-lg">Altura (ou aproximada)</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Estilo de fabricação</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tipo de central</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tamanho do rolamento</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Acompanha espaçadores e cones?</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tipo de caixa</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tamanho da tampa (ou aproximado)</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Acompanha espaçadores ou anel de compressão?</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tamanho da rosca</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Construção interna</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Vendido unidade ou par</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Encaixe</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tipo de tração</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tipo de construção</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tamanho dos braços</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Acompanha eixo?</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                ...
                <Text className="text-lg">Indicação do pneu</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tamanho do pneu</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Construção da banda lateral</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                ...
                <Text className="text-lg">Medida do quadro (ou aproximado)</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Modalidade indicada</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tipo de direção</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Possui esticador de corrente?</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tolerância máxima de pneu</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Possui pinos de freio?</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
                ...
                <Text className="text-lg">Tipo de abraçadeira</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Lado</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-8">
        ...
        return(
            <View>
                <Text className="text-2xl mb-8">Aspectos Específicos</Text>
                <Text className="text-lg">Tipo de raio</Text>
                <View className="border bg-purple-100 border-black rounded-md mb-6">
